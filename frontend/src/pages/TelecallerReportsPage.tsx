    ...
    <div className="space-y-8 max-w-[1400px] mx-auto text-left px-4 md:px-8 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card-premium p-5 flex items-center justify-between">
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Active Calling Agents</span>
            <h4 className="text-2xl font-[850] text-[#0F172A] dark:text-white">{telecallersList.length}</h4>
          </div>
        ...
        <div className="card-premium p-5 flex items-center justify-between">
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Total Calls Logged</span>
            <h4 className="text-2xl font-[850] text-sky-600 dark:text-sky-400">142</h4>
          </div>
        ...
        <div className="card-premium p-5 flex items-center justify-between">
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Converted Leads</span>
            <h4 className="text-2xl font-[850] text-emerald-600 dark:text-emerald-400">38</h4>
          </div>
        ...
        <div className="card-premium p-5 flex items-center justify-between">
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Avg Conversion Rate</span>
            <h4 className="text-2xl font-[850] text-amber-600 dark:text-amber-400">26.8%</h4>
          </div>
